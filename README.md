...
This repository contains the Node.js code examples from the LinkedIn Learning course **Build with AI: Create Apps for ChatGPT Using the Apps SDK**. The full course can be found on [LinkedIn Learning](https://www.linkedin.com/learning/).

![Build with AI: Create Apps for ChatGPT Using the Apps SDK](https://github.com/LinkedInLearning/build-with-ai-create-apps-for-chatgpt-using-the-apps-sdk-ugc-4750017/blob/main/course_image.png)
